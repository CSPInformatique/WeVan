...
public class GoogleCalendar {
	private static final String APPLICATION_NAME = "wevan";
	...
	private static Credential authorize() throws Exception {
				...
				.load(JSON_FACTORY,
						new InputStreamReader(
								GoogleCalendar.class
										.getResourceAsStream("/google/calendar/client_secrets.json")));
		if (clientSecrets.getDetails().getClientId().startsWith("Enter")
			...
			System.out
					.println("Overwrite the src/main/resources/client_secrets.json file with the client secrets file "
							...
							+ "from https://code.google.com/apis/console/?api=calendar#project:141051216875 "
		...
		GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
				httpTransport, JSON_FACTORY, clientSecrets, scopes).setApprovalPrompt("auto").build();
